...
import thread.feature_nmb.generated.resources.core_ui_server_error
...
private val sampleWords = listOf(
    "Apple" to Res.drawable.compose_multiplatform,
    "Banana" to Res.drawable.compose_multiplatform,
    "Cherry" to Res.drawable.compose_multiplatform,
    "Date" to Res.drawable.compose_multiplatform,
    "Elderberry" to Res.drawable.compose_multiplatform,
    "Fig" to Res.drawable.compose_multiplatform,
    "Grape" to Res.drawable.compose_multiplatform,
    "Honeydew" to Res.drawable.compose_multiplatform,
...
private fun DetailContent(
    ...
    Column(
        ...
        if (definedWord != null) {
            ...
            Text(
                text = stringResource(Res.string.core_ui_server_error)
            )
        }
    }
}
