...
-   [x] **产品打磨 0.26–0.29**: 去控制台味 eyebrow/按钮、Forum 缓存故事闭环、空工作区加源/导入主任务流、阅读节奏与安静动效，以及 forum/core-ui 英文本地化已进入 0.29.0 Desktop 门禁。
-   [ ] **发布候选（0.30）**: 真机回归、全量门禁与可选 tag；剩余次级页面继续按主路径迭代。
