...
def test_user_api_key(site_url_base: str, key: str) -> None:
    ...
    r = requests.put(
        # f'https://linux.do/discourse-reactions/posts/80358/custom-reactions/heart/toggle.json',
        f'https://linux.do/categories.json?include_subcategories=true',
...
def main() -> None:
    ...
    result = generate_user_api_key(site_url_base, 'Sample Discourse App')
